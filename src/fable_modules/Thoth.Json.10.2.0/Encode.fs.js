...
import { comparePrimitives, Lazy, disposeSafe, getEnumerator, defaultOf } from "../fable-library-js.4.24.0/Util.js";
import { empty, map as map_5, tryFind, add, toList } from "../fable-library-js.4.24.0/Map.js";
import { toString as toString_2 } from "../fable-library-js.4.24.0/BigInt.js";
import { toString as toString_3 } from "../fable-library-js.4.24.0/Date.js";
import { toString as toString_4 } from "../fable-library-js.4.24.0/TimeSpan.js";
import { map as map_1 } from "../fable-library-js.4.24.0/List.js";
import { defaultArg, map as map_2, defaultArgWith, some } from "../fable-library-js.4.24.0/Option.js";
import { toString as toString_5, FSharpRef } from "../fable-library-js.4.24.0/Types.js";
import { class_type, getGenerics, getGenericTypeDefinition, getTupleFields, getTupleElements, isTuple, isGenericType, getEnumUnderlyingType, isEnum, getElementType, isArray, getUnionCaseFields, getUnionFields, isUnion, getRecordElements, getRecordField, name, isRecord, fullName as fullName_1 } from "../fable-library-js.4.24.0/Reflection.js";
import { item, setItem, fill, map as map_3 } from "../fable-library-js.4.24.0/Array.js";
import { Util_CachedEncoders, Util_Cache$1__GetOrAdd_43981464, CaseStrategy, Util_Casing_convert } from "./Types.fs.js";
import { mapIndexed, map as map_4, fold } from "../fable-library-js.4.24.0/Seq.js";
...
function autoEncodeRecordsAndUnions(extra, caseStrategy, skipNullField, t) {
    ...
    if (matchValue === "") {
        ...
        extra_1 = add(fullName, encoderRef, extra);
    }
    let encoder;
    if (isRecord(t, true)) {
                ...
                if (fullname_1 === "Microsoft.FSharp.Core.FSharpOption`1[System.Object]") {
                    ...
                    if ((fullName_1(keyType) === "System.String") ? true : (fullName_1(keyType) === "System.Guid")) {
                        return (value_16) => fold((target, _arg) => {
                            ...
                            const v_1 = activePatternResult[1];
                        ...
                        return (value_17) => seq(map_4((_arg_1) => {
                            ...
                            const v_2 = activePatternResult_1[1];
...
export function Auto_generateBoxedEncoderCached_437914C6(t, caseStrategy, extra, skipNullField) {
    ...
    key = (defaultArg(map_2((e) => e.Hash, extra), "") + y_1);
